...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 12, 2021 at 03:05 PM
...
CREATE TABLE IF NOT EXISTS `dr_results` (
  ...
  `games_users_id` int(11) NOT NULL,
  `score` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `games_users_id` (`games_users_id`)
...
(123, 7, 4, 3, NULL, NULL, 1),
(124, 7, 5, 4, NULL, NULL, 1),
(125, 7, 2, 5, NULL, NULL, 1),
(126, 7, 8, 6, NULL, NULL, 1),
(127, 7, 9, 7, NULL, NULL, 1),
(128, 7, 6, 8, NULL, NULL, 1),
(129, 7, 7, 9, NULL, NULL, 1),
(130, 7, 10, 10, NULL, NULL, 1),
(131, 7, 14, 18, NULL, 14, 1),
(132, 7, 11, 11, NULL, NULL, 1),
(133, 7, 13, 18, NULL, 14, 1),
(134, 7, 12, 12, NULL, NULL, 1),
(135, 7, 15, 18, NULL, 14, 1),
(136, 7, 16, 13, NULL, NULL, 1),
(137, 7, 17, 14, NULL, NULL, 1),
(138, 7, 18, 15, NULL, NULL, 1),
(139, 7, 19, 16, NULL, NULL, 1),
(140, 7, 20, 17, NULL, NULL, 1);
...
CREATE TABLE IF NOT EXISTS `dr_turns` (
  ...
  KEY `Game_ID` (`game_id`),
  KEY `Player_ID` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=440 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(7, 'Another', 'X', 2, '2021-03-12 14:35:04', '2021-03-12 14:35:11');
...
ALTER TABLE `dr_results`
  ADD CONSTRAINT `dr_results_ibfk_1` FOREIGN KEY (`games_users_id`) REFERENCES `games_users` (`id`);
