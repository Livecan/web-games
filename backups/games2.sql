...
INSERT INTO `users` (`id`, `name`, `password`, `is_admin`, `order_number`, `next_user_id`) VALUES
(1, 'Livecan', '$2y$10$uNezhrCWf7ChyHqXMzYOgOavqJIMlc5YXLhMwv3KhlH5S7dcpdqgC', 1, NULL, NULL),
(3, 'Rebekah', '', 0, NULL, NULL),
(7, 'Mr X', '', 0, NULL, NULL);
