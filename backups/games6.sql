...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 15, 2021 at 10:40 AM
...
INSERT INTO `dr_tokens_games` (`id`, `game_id`, `dr_token_id`, `position`, `user_id`, `group_number`, `id_token_state`) VALUES
...
ALTER TABLE `dr_tokens_games`
  ...
  ADD CONSTRAINT `dr_tokens_games_ibfk_4` FOREIGN KEY (`id_token_state`) REFERENCES `dr_token_states` (`id`);
