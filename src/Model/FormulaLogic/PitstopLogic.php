...
class PitstopLogic {
    ...
    public function fixCar(FoCar $foCar) {
        ...
        $foCar->pits_state = FoCar::PITS_STATE_IN_PITS;
        $foCar->save();
    }
    ...
    public function finishPitstop(FoCar $foCar, callable $moveCar) {
        ...
        if ($pitstopRoll < DiceLogic::BLACK_LONG_PITSTOP_BOTTOM) {
            ...
            $foCar->gear = 3;
            $foCar->order = null;
            $foCar->pits_state = FoCar::PITS_STATE_LONG_STOP;
            $foCar->save();
        }
